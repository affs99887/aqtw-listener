# 行商听音助手 · Windows 预览版 v0.3.0

按格数展示候选缩略图的本地听音浮窗。当前为 **监听浮窗与个人音效库预览版，尚未完成实战准确率验收**。

本版说明见 [v0.3.0 发布说明](docs/releases/v0.3.0.md)，[v0.2.0 发布说明](docs/releases/v0.2.0.md)保留为历史记录。当前版本将实时监听与声音操作合并到同一浮窗：全部候选按格数连续展示、逐件参考试听、顶部回放与字号切换、同一图钉亮暗切换；识别中显示加载动画，失败时显示醒目提示。设计背景见[需求记录](docs/handoff/REQUIREMENTS-20260922-1519.md)和[设计册](docs/design/README.md)。
